  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 gap-4 bg-surface p-6 shadow-elevation-4 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
          side === "top" &&
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm text-on-surface-muted transition-colors hover:text-on-surface focus:outline-none focus:ring-2 focus:ring-border-focus disabled:pointer-events-none">
          <X className="h-4 w-4" />
